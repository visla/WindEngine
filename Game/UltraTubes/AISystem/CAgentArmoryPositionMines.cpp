/*
	Filename:	CAgentArmoryPositionMines.cpp
...
CAgentArmoryPositionMines::~CAgentArmoryPositionMines()
{
}


void CAgentArmoryPositionMines::Tick(CInputMessage *Msg)
{
	Msg->FireMine = false;
	...
	for (int i = 0; i < MAX_PLAYERS; i++)
	{
		...
		if ( (Target->Position < Avatar->Position) && (Target->LapCount < Avatar->LapCount) ) continue;
